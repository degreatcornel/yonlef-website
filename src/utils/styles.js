export const styles = {
  ...
  heading: "text-3xl md:text-4xl font-bold text-center mb-10",

  subText: "text-gray-600 text-lg",

  card:
    "bg-white p-6 rounded-xl shadow hover:shadow-lg transition duration-300",
